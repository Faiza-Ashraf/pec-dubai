...
export default function AboutPage() {
  return (
    <main className="flex-1">
      <section className="border-b border-[var(--color-gold-border)] bg-[var(--color-obsidian)] pb-16 pt-28 sm:pb-20 sm:pt-32">
        <Container>
          <p className="font-mono text-[0.6rem] uppercase tracking-[0.35em] text-[var(--color-gold)]">
            About PEC
          </p>
          <h1 className="mt-5 max-w-4xl font-display text-[clamp(3rem,7vw,6.5rem)] font-light leading-[0.94] text-[var(--color-white)]">
            Design ambition, technical discipline, and calm delivery.
          </h1>
          <p className="mt-6 max-w-2xl text-[1rem] leading-8 text-[var(--color-fog)]">
