  ...
  return (
    ...
    >
      <Container>
          ...
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-[14px]">
                ...
                <div>
                  <p className="text-[0.82rem] font-medium text-[var(--color-charcoal)]">{testimonial.author}</p>
                  <p className="mt-0.5 text-[0.68rem] text-[var(--color-cool-gray)]">{testimonial.role}</p>
                </div>
              </div>
            </article>
          ))}
        ...
        <div className="mt-[52px] grid border border-[var(--color-divider)] sm:grid-cols-2 lg:grid-cols-4">
          {trustStats.map((stat) => (
            <div
              key={stat.value}
