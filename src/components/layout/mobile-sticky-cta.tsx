  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex items-center gap-[10px] rounded-full bg-[var(--color-deep-charcoal)] px-5 py-[13px] text-[0.75rem] font-medium text-white shadow-[0_8px_32px_rgba(50,56,66,0.24)] transition hover:-translate-y-1 hover:bg-[var(--color-charcoal)] hover:shadow-[0_16px_48px_rgba(44,51,60,0.28)]"
      >
