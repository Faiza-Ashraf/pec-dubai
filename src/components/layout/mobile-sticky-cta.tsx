  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex items-center gap-[10px] rounded-full bg-[rgba(29,36,48,0.94)] px-5 py-[13px] text-[0.75rem] font-medium text-white shadow-[0_8px_32px_rgba(29,36,48,0.24)] transition hover:-translate-y-1 hover:bg-[var(--color-steel-blue)] hover:shadow-[0_16px_48px_rgba(29,36,48,0.28)]"
      >
